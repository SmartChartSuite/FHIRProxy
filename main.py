...
# Making a global timeout for httpx
httpx._config.DEFAULT_TIMEOUT_CONFIG = httpx.Timeout(timeout=300)
...
def custom_openapi():
    ...
    openapi_schema = get_openapi(title=app_title, version=app_version, routes=app.routes)
